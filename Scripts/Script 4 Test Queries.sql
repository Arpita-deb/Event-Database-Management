...
FROM 
	[dbo].[Event]
WHERE 
	[start_date] BETWEEN DATEFROMPARTS(2024, 10, 01)  AND DATEFROMPARTS(2024, 10, 31) -- For October 2024
...
/*
11. How many events have been canceled, postponed, or rescheduled overall?
...
SELECT Status = COALESCE([status], 'Proposed'), 
	Event_Count = COUNT(*)
FROM 
	[dbo].[Event]
GROUP BY 
